    ...
    <div className="min-h-screen bg-surface flex items-center justify-center p-4">
      <div className="w-full max-w-md card-animate">
        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl ring-1 ring-brand-100 shadow-brand-xl p-8">
          <h2 className="text-2xl font-bold text-brand-900 mb-1 tracking-tight">Reset your password</h2>
          ...
          {submitted ? (
            <div className="text-center py-4">
              ...
              <p className="text-brand-900 font-semibold mb-1">Check your email</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="forgotpasswordpage-email-1" className="block text-sm font-semibold text-slate-700 mb-1.5">Email</label>
                <input id="forgotpasswordpage-email-1"
                  type="email"
                  value={email}
