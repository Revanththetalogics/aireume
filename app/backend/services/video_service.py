        ...
        if parsed:
            ...
            for p in pauses:
                flags.append({
                    ...
                    "severity": p["severity"],
                    "evidence": (
                        f"{p['duration_s']}s pause at {p['formatted_at']} — "
                        f"after \"{p['before_text'][:60]}\""
                    ),
                    "recommendation": (
                        "Ask the candidate directly what happened during this pause "
