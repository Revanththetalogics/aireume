...
def upgrade() -> None:
    ...
    if 'skill_classification_templates' in insp.get_table_names():
        return
    op.create_table(
...
def downgrade() -> None:
    op.drop_index("ix_skill_class_tmpl_name", table_name="skill_classification_templates")
    op.drop_index("ix_skill_class_tmpl_tenant", table_name="skill_classification_templates")
